...
import {
  ...
  FiMenu, FiX, FiLogOut, FiBell, FiBellOff, FiSettings, FiTag, FiHome, FiDollarSign
} from 'react-icons/fi'
...
import CategoryRates from './admin/CategoryRates'
...
const navItems = [
  ...
  { path: 'category-rates', label: 'Category Rates', icon: FiDollarSign },
        ...
        <main className="flex-1 overflow-y-auto p-3 sm:p-6">
          <AnimatePresence mode="wait">
            <Routes>
              ...
              <Route path="category-rates" element={<motion.div key="category-rates" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }} transition={{ duration: 0.2 }}><CategoryRates /></motion.div>} />
